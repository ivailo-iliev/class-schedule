-- Include the complete size of a booking series in the authorized details projection.
...
begin
  ...
  select count(*)::integer into series_total
  from public.bookings series_booking
  where series_booking.series_id = booking_row.series_id;
